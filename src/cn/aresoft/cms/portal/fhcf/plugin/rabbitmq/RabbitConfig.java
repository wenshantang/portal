...
public class RabbitConfig {
	...
	public RabbitConfig(String serverHost) {
	...
	public RabbitConfig(String serverHost, int port, String username, String password, String virtualHost, int connectionTimeout, int eventMsgProcessNum, int prefetchSize) {
